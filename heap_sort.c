...
void reconstruir(int v[], int limit, int pos)
{		
	int c1, c2;
	...
	if(greater_index != -1)
	{
		...
		v[pos - 1] = aux;
		reconstruir(v, limit, greater_index);
	}
}


void construir(int v[], int size_v)
{
	int left;
